...
const contactInfo = [
    {
        icon: Mail,
        label: "Email",
        value: "ronneldarylrontos@gmail.com",
        href: "mailto:ronneldarylrontos@gmail.com",
    },
    {
        icon: Phone,
        label: "Phone",
        value: "09928137915",
        href: "mobile:+639928137915",
    },
    {
        icon: MapPin,
        label: "Location",
                ...
                <div className="grid lg:grid-cols-2 gap-12 max-w-5xl mx-auto">
                    ...
                    <div className="glass rounded-3xl p-8 border border-primary/30">
                        ...
                        <p className="text-muted-foreground text-sm">
                            Im currently open to new opputunities and exciting projects, whether you need a full time developer or free lance lets talk
                        </p>
                    </div>
                    </div>
